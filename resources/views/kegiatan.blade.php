        ...
        <div class="px-6 mx-auto max-w-7xl lg:px-8">
            <div class="max-w-2xl mx-auto text-center ">
                <h2 class="text-4xl font-semibold tracking-tight dark:bg-gray-900 dark:text-gray-100 sm:text-5xl">
                    Kegiatan Kami</h2>
                <p class="mt-2 text-lg dark:bg-gray-900 dark:text-gray-100">Selamat datang, Berikut merupakan kegiatan
                    yang ada di gahita</p>
            </div>
            <div
                ...
                @foreach ($articles as $article)
                    <article
                        ...
                        <h3
                            class="mt-3 text-lg font-semibold dark:bg-gray-900 dark:text-gray-100 group-hover:text-gray-600">
