<div>
    <footer class="bg-white dark:bg-gray-900">
        <div class="container p-6 mx-auto">
                ...
                <div class="mt-6 lg:mt-0 lg:flex-1">
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                        ...
                        <div>
                            ...
                            <a href="#" class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Foto</a>
                        ...
                        <div>
                            ...
                            <span class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Jln. Silungan, Desa Lodtunduh, Kec. Ubud, Kab. Gianyar, Bali 80571</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div>
                <p class="text-center text-gray-500 dark:text-gray-400">© Saifulloh Rahman 2025 - All rights reserved</p>
            </div>
        </div>
    </footer>
</div>