<div class="py-24 bg-white sm:py-32 dark:bg-gray-900">
    <div class="px-6 mx-auto max-w-7xl lg:px-8">
        <div class="max-w-2xl mx-auto lg:text-center">
            ...
            <p class="mt-2 text-4xl font-semibold tracking-tight text-gray-900 text-pretty sm:text-5xl lg:text-balance dark:text-white animate-on-scroll animate-fade-in" style="animation-delay: 0.1s;">Semua yang Kamu Butuhkan</p>
            <p class="mt-6 text-gray-600 dark:text-gray-300 text-lg/8 animate-on-scroll animate-fade-in" style="animation-delay: 0.2s;">Platform pembelajaran yang dirancang untuk membantu Anda menguasai keterampilan baru dengan mudah dan menyenangkan. Mulai dari materi dasar hingga lanjutan, semua tersedia di sini.</p>
        </div>
        <div class="max-w-2xl mx-auto mt-16 sm:mt-20 lg:mt-24 lg:max-w-4xl">
            <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
                ...
                <div class="relative pl-16 animate-on-scroll animate-slide-in-right">
                    ...
                    <dd class="mt-2 text-gray-600 dark:text-gray-300 text-base/7">Nikmati pengalaman belajar interaktif dengan video, kuis, dan proyek praktis yang menarik.</dd>
                </div>
            </dl>
        </div>
    </div>
