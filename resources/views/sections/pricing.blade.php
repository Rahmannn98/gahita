<div class="relative px-6 py-24 bg-white dark:bg-gray-900 isolate sm:py-32 lg:px-8">
    ...
    <div class="max-w-4xl mx-auto text-center">
      <h2 class="font-semibold text-indigo-600 dark:text-indigo-400 text-base/7">Pricing</h2>
      <p class="mt-2 text-5xl font-semibold tracking-tight text-gray-900 dark:text-white text-balance sm:text-6xl">Choose the right plan for you</p>
    </div>
    <p class="max-w-2xl mx-auto mt-6 text-lg font-medium text-center text-gray-600 dark:text-gray-400 text-pretty sm:text-xl/8">Choose an affordable plan that’s packed with the best features for engaging your audience, creating customer loyalty, and driving sales.</p>
    <div class="grid items-center max-w-lg grid-cols-1 mx-auto mt-16 gap-y-6 sm:mt-20 sm:gap-y-0 lg:max-w-4xl lg:grid-cols-2">
      <div class="p-8 rounded-3xl rounded-t-3xl bg-white/60 dark:bg-gray-800/60 ring-1 ring-gray-900/10 dark:ring-gray-700/10 sm:mx-8 sm:rounded-b-none sm:p-10 lg:mx-0 lg:rounded-tr-none lg:rounded-bl-3xl">
        <h3 id="tier-hobby" class="font-semibold text-indigo-600 dark:text-indigo-400 text-base/7">Hobby</h3>
        ...
        <p class="mt-6 text-gray-600 dark:text-gray-400 text-base/7">The perfect plan if you're just getting started with our product.</p>
        <ul role="list" class="mt-8 space-y-3 text-gray-600 dark:text-gray-400 text-sm/6 sm:mt-10">
          <li class="flex gap-x-3">
            <svg class="flex-none w-5 h-6 text-indigo-600 dark:text-indigo-400" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
